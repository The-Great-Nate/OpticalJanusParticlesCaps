...
def perform_simulation(number_of_particles, positions, sphere_radius, dipole_radius, array_of_rotated_dipoles):
    ...
    for i in range(number_of_timesteps):
        ...
        if include_nonbonded == True:
            ...
            nonbonded = pyf.non_bonded_array(number_of_particles, displacements_matrix, position_vectors, nonbonded_exceptions, sphere_radius)
...
# filestem = os.path.join(dir_path, sys.argv[1])
...
for particle_iterator in range(n_particles):
    ...
    array_of_rotated_dipoles[particle_iterator] = array_of_rotated_dipoles[particle_iterator] @ init_rotation
